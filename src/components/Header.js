...
function Header() {
  ...
  return (
    <div className="h-screen  flex text-center">
      <span className="absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 md:text-8xl text-6xl text-custom-white font-[Montserrat] selection:bg-custom-theme selection:text-custom-white md:border-b-4 border-b-2 border-custom-theme pb-5">
        ARC Yapı
      </span>
